...
public final class ModPotionInstances {
    ...
    public static final Potion HEALING_III = new Potion(new MobEffectInstance(MobEffects.HEAL, 1, 2));
    public static final Potion GODLY_HEALING = new Potion(new MobEffectInstance(MobEffects.HEAL, 1, 4));
}
